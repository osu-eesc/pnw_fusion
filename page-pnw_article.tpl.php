                            ...
                            <div id="content-inner" class="content-inner block">
                              <div id="content-inner-inner" class="content-inner-inner inner">
															      ...
															      <ul class="links inline">
															        ...
															        <?php print_r($template_files);
															          if ($node->links['gallery_field_attach_to'])
															          {
														                print '<li class="gallery_field_attach_to"><a href="' . $node->links['gallery_field_attach_to']['href'] . '?' .  $node->links['gallery_field_attach_to']['query'] . '">' . $node->links['gallery_field_attach_to']['title'] . '</a></li>';
														              }
														              if ($node->links['link_field_attach_to'])
															          {
														                print '<li class="link_field_attach_to"><a href="' . $node->links['link_field_attach_to']['href'] . '?' . $node->links['link_field_attach_to']['query'] . '">' . $node->links['link_field_attach_to']['title'] . '</a></li>';
														              }
														            ?>
														          </ul>
